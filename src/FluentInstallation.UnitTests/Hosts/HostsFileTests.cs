...
namespace FluentInstallation.Hosts
{
    public class HostsFileTests
    {
        ...
        [Fact]
        public void AddHostEntry_DisablesDuplicateEntriesWithTheSameHostName()
        {
            var sut = new HostsFile();
            var hostEntry1 = new HostEntry() { HostName = "mysite.co.uk", IsEnabled = true};
            var hostEntry2 = new HostEntry() { HostName = "mysite.co.uk", IsEnabled = true};
        ...
        {
            var hostsFile = HostsFile.Load(TestContext.GetResourceStream("FluentInstallation.Hosts.Hosts.txt"));
